            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @if(Auth::check())
                    ...
                    @if($role === 'teacher')
                        ...
                        <x-nav-link :href="route('teacher.assessments')" :active="request()->routeIs('teacher.assessments')">
                            {{ __('Assessments') }}
                        </x-nav-link>
                    @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-200 hover:text-gray-700 dark:hover:text-white focus:outline-none focus:text-gray-700 dark:focus:text-white transition duration-150 ease-in-out">
